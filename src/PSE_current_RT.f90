...
subroutine PSE_current_RT(jav)
  ...
  Band : do ib=1,NB_TD
    ...
    do i=1,NL
      zt(1)= &!nab1(0)*tpsi(i)&
        &+nab1(1)*(zu(ifdx1(1,i),ib,ik)-zu(ifdx1(-1,i),ib,ik))&
        &+nab1(2)*(zu(ifdx1(2,i),ib,ik)-zu(ifdx1(-2,i),ib,ik))&
        &+nab1(3)*(zu(ifdx1(3,i),ib,ik)-zu(ifdx1(-3,i),ib,ik))&
        &+nab1(4)*(zu(ifdx1(4,i),ib,ik)-zu(ifdx1(-4,i),ib,ik))

      zt(2)= &!nab1(0)*tpsi(i)&
        &+nab2(1)*(zu(ifdx2(1,i),ib,ik)-zu(ifdx2(-1,i),ib,ik))&
        &+nab2(2)*(zu(ifdx2(2,i),ib,ik)-zu(ifdx2(-2,i),ib,ik))&
        &+nab2(3)*(zu(ifdx2(3,i),ib,ik)-zu(ifdx2(-3,i),ib,ik))&
        &+nab2(4)*(zu(ifdx2(4,i),ib,ik)-zu(ifdx2(-4,i),ib,ik))
      
      zt(3)= &!nab1(0)*tpsi(i)&
        &+nab3(1)*(zu(ifdx3(1,i),ib,ik)-zu(ifdx3(-1,i),ib,ik))&
        &+nab3(2)*(zu(ifdx3(2,i),ib,ik)-zu(ifdx3(-2,i),ib,ik))&
        &+nab3(3)*(zu(ifdx3(3,i),ib,ik)-zu(ifdx3(-3,i),ib,ik))&
        &+nab3(4)*(zu(ifdx3(4,i),ib,ik)-zu(ifdx3(-4,i),ib,ik))
      
      jx1t=jx1t+aimag(conjg(zu(i,ib,ik))*zt(1))
      jx2t=jx2t+aimag(conjg(zu(i,ib,ik))*zt(2))
      jx3t=jx3t+aimag(conjg(zu(i,ib,ik))*zt(3))
    end do
  ...
  Band2 : do ib=1,NB_TD
    ...
    do ilma=1,Nlma
      ...
      do j=1,Mps(ia)
        ...
        uVpsi =uVpsi +uV(j,ilma)*ekr(j,ia,ik)  *zu(i,ib,ik)
        uVpsix=uVpsix+uV(j,ilma)*ekr(j,ia,ik)*x1*zu(i,ib,ik)
        uVpsiy=uVpsiy+uV(j,ilma)*ekr(j,ia,ik)*x2*zu(i,ib,ik)
        uVpsiz=uVpsiz+uV(j,ilma)*ekr(j,ia,ik)*x3*zu(i,ib,ik)
      end do
