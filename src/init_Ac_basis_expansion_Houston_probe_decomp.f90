...
! pump laser
    do iter=0,Nt+2
      ...
      if (tt<tpulse_1) then
        ...
        Ac_pump_BE(iter)=-f0_1/omega_1*(cos(pi*(tt-0.5d0*tpulse_1)/tpulse_1))**2*sin(omega_1*(tt-0.5d0*tpulse_1)+phi_CEP_1*2d0*pi)
      end if
    enddo
! probe laser
    do iter=0,Nt+2
...
! pump laser
    do iter=0,Nt+2
      ...
      if (tt<tpulse_1) then
        ...
        Ac_pump_BE(iter)=-f0_1/omega_1*(cos(pi*(tt-0.5d0*tpulse_1)/tpulse_1))**4*sin(omega_1*(tt-0.5d0*tpulse_1)+phi_CEP_1*2d0*pi)
